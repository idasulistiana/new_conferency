      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Day-2 (October 11<sup>th</sup>, 2016)</li>
          </ol>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td style="text-align:center"><button class="btn btn-primary" data-toggle="modal" data-target="#edit" onclick="ubah(<?php echo $data->id_ev ?>)">Edit</button></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
